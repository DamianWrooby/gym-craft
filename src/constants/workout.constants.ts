import type { GarminWorkout } from '@/models/plan/plan.model';

export const workoutProperties: (keyof GarminWorkout)[] = [
    'sportType',
    'subSportType',
    'workoutName',
...
const exerciseObj = {
    ...
    INDOOR_BIKE: ['AIR_BIKE', 'ASSAULT_BIKE', 'STATIONARY_BIKE'],
    ...
    RUN: ['JOG', 'RUN', 'RUN_OR_WALK', 'SPRINT', 'WALK'],
    RUN_INDOOR: ['INDOOR_TRACK_RUN', 'TREADMILL'],
    SANDBAG: [
        'AROUND_THE_WORLD',
        'BACK_SQUAT',
        'BEAR_CRAWL_PULL_THROUGH',
    ...
    SLED: ['BACKWARD_DRAG', 'CHEST_PRESS', 'FORWARD_DRAG', 'LOW_PUSH', 'PUSH', 'ROW'],
    SLEDGE_HAMMER: ['LATERAL_SWING', 'HAMMER_SLAM', 'SLEDGE_HAMMER'],
    SQUAT: [
        'AIR_SQUAT',
        'ALTERNATING_BOX_DUMBBELL_STEP_UPS',
        'BACK_SQUAT_WITH_BODY_BAR',
...
export const exerciseMap = new Map<string, Set<string>>();
Object.entries(exerciseObj).forEach(([category, exercises]) => {
    exerciseMap.set(category, new Set(exercises));
});

export const workoutTypesSet = new Set(workoutTypes);
export const workoutCategoriesSet = new Set(workoutCategories);
